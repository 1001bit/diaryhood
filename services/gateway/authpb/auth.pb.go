...
type EmailResponse struct {
	...
	NewAccount bool `protobuf:"varint,1,opt,name=newAccount,proto3" json:"newAccount,omitempty"`
}
...
func (x *EmailResponse) GetNewAccount() bool {
	if x != nil {
		return x.NewAccount
	}
	return false
...
var file_protobuf_auth_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x6e, 0x22, 0x2f, 0x0a, 0x0d, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x6e, 0x65, 0x77, 0x41, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x6e, 0x65, 0x77, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x32, 0x49, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x09, 0x53, 0x65, 0x6e, 0x64, 0x45, 0x6d, 0x61, 0x69, 0x6c,
	0x12, 0x14, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52,
...
var file_protobuf_auth_proto_goTypes = []interface{}{
	(*EmailRequest)(nil),  // 0: userpb.EmailRequest
	(*EmailResponse)(nil), // 1: userpb.EmailResponse
}
var file_protobuf_auth_proto_depIdxs = []int32{
	0, // 0: userpb.AuthService.SendEmail:input_type -> userpb.EmailRequest
	1, // 1: userpb.AuthService.SendEmail:output_type -> userpb.EmailResponse
